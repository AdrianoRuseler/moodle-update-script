...
MOODLE_HOME="/var/www/html/integration" # moodle core folder
MOODLE_DATA="/var/www/moodleintegrationdata"  # moodle data folder
...
git clone --depth=1 --branch=MOODLE_BRANCH https://git.in.moodle.com/moodle/integration.git moodle
if [[ $? -ne 0 ]]; then
